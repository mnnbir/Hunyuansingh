    ...
    with gr.Blocks() as demo:
        ...
        with gr.Tab('单主体一致性'):
                ...
                with gr.Column(scale=2):
                    with gr.Accordion("Options for generate video", open=False):
                        with gr.Row():
                            ...
                            height = gr.Slider(256, 1536, 512, step=16, label="Height")
                        with gr.Row():
                        ...
                        with gr.Row():
                            ...
                            seed = gr.Textbox(1234, label="Seed (-1 for random)")
                        with gr.Row():
            ...
            with gr.Row(), gr.Column():
                ...
                example_inps = [
                    [
                        'a boy is riding a bicycle on the street',
                        './assets/images/seg_boy.png',
                        896, 512, 30, 129, 7.5, 13, 1024,
